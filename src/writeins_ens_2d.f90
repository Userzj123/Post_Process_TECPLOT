subroutine writeins_ens_2d(imore)
      use mgeomdata
      use mvariable
      use msetup
      use mindices
      ...
      return
end subroutine writeins_ens_2d
