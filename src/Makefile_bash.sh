...
ifort -r8 -mcmodel=large -shared-intel -o post.exe obj/module.o obj/main.o obj/setup.o obj/openmpcut.o obj/write_grid.o obj/read_rstrt.o obj/mesh.o obj/indices.o obj/writeins3d.o obj/writeins2d.o obj/writeins2d_2.o  -liomp5 -lpthread libtecio.a -lstdc++ 
